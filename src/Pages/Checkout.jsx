...
import { update_total_with_charge } from "../features/Product/productSlice";
                ...
                <div className={styles.inputs}>
                  {options.map((el) => {
                    return (
                      <div
                        key={el.id}
                        onClick={() => handleDeleiveryChange(el.id)}
                        className={styles.input}
                      >
                        <div className={styles.fix}>
                          <input
                            value={el.title}
                            onChange={() => handleDeleiveryChange(el.id)}
                        ...
                        <div className={styles.delivery_method}>
                          <div className={styles.delivery_method_left}>
                            <p className={styles.bold}>{el.title}</p>
                            <p className={styles.light}>{el.delivered_in}</p>
                          </div>
                          <div className={styles.delivery_method_right}>
                            <p className={styles.price}>
                              INR {el.id == 1 ? standardCharge : expressCharge}
                            </p>
                          </div>
                        </div>
                      </div>
